...
import {
  ...
  FileCheck, User, LifeBuoy, Settings, LogOut, ShieldCheck, Zap, X, Shield, Award, ClipboardCheck, DollarSign, Activity
} from 'lucide-react';
...
export default function Sidebar({
  ...
  const menuItems = [
    ...
    { id: 'wallet', name: 'Wallet & Payouts', icon: Wallet },
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <div className="flex items-center gap-1">
                <h4 className="text-sm font-black text-slate-800 dark:text-slate-100 leading-tight">Ramesh Kumar</h4>
                <ShieldCheck size={14} className="text-primary flex-shrink-0" />
              </div>
              <div className="flex items-center gap-1.5 mt-0.5">
                <span className="text-[9px] font-black text-slate-400">ID: WRK-4829</span>
                <span className="inline-block w-1 h-1 rounded-full bg-slate-300" />
                <span className="text-[9px] font-black text-primary uppercase">Electrician</span>
              </div>
            </div>
          </div>
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-black uppercase tracking-wider text-left transition-all duration-200 cursor-pointer ${
                  isActive 
                    ...
                    : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-955 hover:text-slate-800 dark:hover:text-slate-200'
                }`}
              >
