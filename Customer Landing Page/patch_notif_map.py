...
replacement_str = """                      {notifications.map((notif) => (
...
# find the exact old mapping string
old_str = """                      {notifications.map((notif) => (
...
if old_str in content:
    content = content.replace(old_str, replacement_str)
else:
