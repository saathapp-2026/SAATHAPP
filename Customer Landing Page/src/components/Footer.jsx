      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ul className="space-y-4 text-xs font-semibold text-slate-400 text-left">
              ...
              <li className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <a href="mailto:support@saathapp.in" className="hover:text-white transition-colors">support@saathapp.in</a>
                </div>
              </li>
              <li className="flex items-start gap-2.5">
                <Mail size={14} className="text-primary shrink-0 mt-0.5" />
        ...
        <div className="py-6 border-b border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2 text-[10px] sm:text-[11px] font-bold text-slate-450 justify-center">
            <span className="px-2.5 py-1 rounded bg-slate-800/60 border border-slate-700/30">UPI</span>
            <span className="px-2.5 py-1 rounded bg-slate-800/60 border border-slate-700/30">RuPay</span>
            <span className="px-2.5 py-1 rounded bg-slate-800/60 border border-slate-700/30">Visa</span>
            <span className="px-2.5 py-1 rounded bg-slate-800/60 border border-slate-700/30">Mastercard</span>
            <span className="px-2.5 py-1 rounded bg-slate-800/60 border border-slate-700/30">Net Banking</span>
            <span className="px-2.5 py-1 rounded bg-slate-800/60 border border-slate-700/30">Cash on Delivery (where available)</span>
          </div>
        </div>
