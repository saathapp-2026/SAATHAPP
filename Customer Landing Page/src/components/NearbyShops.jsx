  ...
  return (
    <section className="py-12 bg-slate-50 dark:bg-slate-950/40 border-b border-slate-100 dark:border-slate-800/40 relative w-full">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        >
          {nearbyShops.length === 0 ? (
            <div className="w-full py-10 text-center text-sm font-semibold text-slate-400">
              No nearby shops listed at the moment.
            </div>
          ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full h-36 bg-slate-200 relative overflow-hidden">
                    ...
                    <div className={`absolute -bottom-5 left-4 w-12 h-12 rounded-2xl ${shop.color || 'bg-slate-700'} text-white font-extrabold flex items-center justify-center text-sm shadow-md border-2 border-white dark:border-slate-900 z-10`}>
                      {shop.logo || 'S'}
                    </div>
                  ...
                  <div className="p-4.5 pt-7 text-left space-y-4">
                    ...
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <motion.button
                        disabled={isClosed}
                        onClick={() => onShopSelect && onShopSelect(shop)}
