        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="pt-6 flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-amber-500 hover:bg-amber-400 px-8 py-3.5 text-base font-extrabold text-slate-950 shadow-xl transition hover:scale-[1.03]"
            >
              <Send size={18} />
