        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="transition-all duration-200 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none inline-flex items-center gap-1.5 rounded-2xl border border-amber-500/30 bg-amber-500/10 px-4 py-2.5 text-xs font-extrabold text-amber-600 dark:text-amber-400 hover:bg-amber-500/20 transition disabled:opacity-50"
            >
            ...
            {isApproved && (
              <button
                ...
                className="transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none inline-flex items-center gap-2 rounded-2xl bg-amber-500 hover:bg-amber-400 px-6 py-2.5 text-xs font-extrabold text-slate-950 shadow-lg transition hover:scale-[1.03]"
              >
                <Truck size={16} />
        ...
        {isApproved && (
          <div className="mt-8 p-6 rounded-3xl bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 text-slate-950 text-center shadow-xl">
            ...
            <button
              type="button"
              onClick={onGoToDashboard}
              className="transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none mt-6 inline-flex items-center gap-2 rounded-2xl bg-slate-950 text-white hover:bg-slate-900 px-8 py-3.5 text-sm font-extrabold shadow-2xl transition hover:scale-105"
            >
              <Truck size={18} />
