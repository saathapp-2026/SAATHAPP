...
export default function BookingCard({
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-full bg-slate-50 dark:bg-slate-950 flex items-center justify-center text-slate-500">
              <User size={16} />
            </div>
            <div>
      ...
      {/* Basic details bar */}
      <div className="px-5 py-3.5 bg-slate-50 dark:bg-slate-950 border-y border-slate-150 dark:border-slate-850 grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div className="px-5 py-3 flex items-center justify-between gap-4">
        <button
          ...
          className="text-[10px] font-black uppercase tracking-wider text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 flex items-center gap-1 cursor-pointer"
        >
      ...
      <AnimatePresence>
        {expanded && (
          ...
          >
            <div className="p-5 bg-white dark:bg-slate-900 space-y-4 text-xs sm:text-sm text-slate-600 dark:text-slate-400 font-medium leading-relaxed">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      className="px-2.5 py-1 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-primary hover:text-white text-slate-500 font-extrabold text-[10px] transition-colors"
                    >
                      Call User
                    </a>
                    <button
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800 rounded-xl space-y-3 mt-4">
                  ...
                  <form onSubmit={handleStartWithOtp} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 text-xs border border-slate-250 dark:border-slate-800 rounded-xl bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 outline-none focus:border-primary/50"
                    />
                    <button
                      type="submit"
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-slate-800/40 grid grid-cols-2 md:grid-cols-4 gap-4 text-left">
                <div>
