...
export default function Sidebar({
  ...
  const menuItems = [
    ...
    { id: 'wallet', name: 'Payments', icon: Wallet },
    { id: 'membership', name: 'Membership', icon: Crown },
    { id: 'welcome_kit', name: 'Welcome Kit', icon: Package },
    { id: 'verification', name: 'Verification', icon: ShieldCheck },
    { id: 'onboarding_info', name: 'Onboarding Info', icon: ClipboardList },
    { id: 'fee_summary', name: 'Fee Summary', icon: IndianRupee },
    { id: 'equipment', name: 'Equipment', icon: Wrench },
    { id: 'business_services', name: 'Business Services', icon: Briefcase },
