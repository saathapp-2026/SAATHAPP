...
export default function Topbar({
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-white/40 dark:border-slate-800/80 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl py-3 px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-1 sm:gap-2 shrink-0">
        <button
          ...
          className="p-2 rounded-xl text-slate-500 hover:text-primary hover:bg-white/80 dark:hover:bg-slate-800 transition-colors"
          title="Toggle theme"
        >
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-2 rounded-xl border border-slate-200/60 dark:border-slate-700 hover:bg-white/80 dark:hover:bg-slate-800 text-xs font-bold text-slate-600 dark:text-slate-300"
          >
            <Globe size={14} />
          ...
          <AnimatePresence>
            {langDropdown && (
              <motion.div
                ...
                exit={{ opacity: 0, y: 8 }}
                className="absolute right-0 mt-1.5 w-36 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800 rounded-2xl shadow-premium py-1 z-50"
              >
                {['English', 'Hindi', 'Bengali'].map((lang) => (
                  <button
                    ...
                    className="w-full px-3 py-2 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center justify-between"
                  >
                    {lang}
        ...
        <button
          ...
          className="p-2 rounded-xl text-slate-500 hover:text-primary hover:bg-white/80 dark:hover:bg-slate-800 relative"
        >
          <Bell size={18} />
            ...
            {profileDropdown && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full px-3 py-2 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2"
                >
