...
export default function NotificationPanel({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 p-6 rounded-card shadow-soft hover:shadow-premium transition-all text-left">
      <div className="flex items-center justify-between mb-6 pb-3 border-b border-slate-105 dark:border-slate-800/40">
        ...
        <button
          onClick={onClearAll}
          className="text-[10px] font-black uppercase text-slate-450 hover:text-slate-600 dark:hover:text-slate-200 cursor-pointer"
        >
          Clear Logs
        </button>
      </div>
