...
function MoreMenu({ customer, onAction, loadingAction }) {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-1 w-52 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-xl p-1 z-[40]">
      ...
      <div className="md:hidden divide-y divide-slate-100 dark:divide-slate-800 border-t border-slate-100 dark:border-slate-800">
        {customers.map((c) => (
          <button
            ...
            type="button"
            onClick={() => onRowClick?.(c)}
            className="w-full text-left p-4 hover:bg-slate-50 dark:hover:bg-slate-800/40"
          >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-4 py-3 border-t border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded-lg text-xs border border-slate-200 dark:border-slate-700 disabled:opacity-40"
          >
            Prev
          </button>
