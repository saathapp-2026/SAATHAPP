...
const PRIMARY = [
  { id: 'export', label: 'Export Selected', icon: Download, className: 'bg-page text-slate-700 hover:bg-slate-200 dark:text-slate-200' },
        ...
        <div className="flex flex-wrap items-center gap-2 flex-1">
          ...
          <div className="relative">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold border border-slate-200"
            >
              <MoreHorizontal size={13} />
              More Actions
            </button>
            {moreOpen && (
              <div className="absolute bottom-full mb-2 left-0 w-48 rounded-xl border border-slate-200 bg-surface shadow-xl p-1 z-[40]">
