    ...
    <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-surface p-3 sm:p-4 space-y-3">
      <div className="flex flex-col lg:flex-row gap-2.5">
        ...
        <select
          ...
          className="rounded-xl border border-slate-200 bg-transparent px-3 py-2.5 text-sm min-w-[140px]"
        >
        ...
        <select
          ...
          aria-label="Status"
          className="rounded-xl border border-slate-200 bg-transparent px-3 py-2.5 text-sm min-w-[120px]"
        >
