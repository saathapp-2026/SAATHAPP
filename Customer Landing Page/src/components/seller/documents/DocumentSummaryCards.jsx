...
const PRIMARY = ['total', 'verified', 'pending', 'compliance'];
...
export default function DocumentSummaryCards({
  cards = [],
  loading,
  onCardClick,
  activeKey,
