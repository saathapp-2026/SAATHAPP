...
export default function ViewReportModal({ open, onClose, report, onDownload, onPrint, onShare }) {
  ...
  return (
    <SellerOverlay open={open} onClose={onClose} labelledBy="view-report-title" zIndex={SELLER_Z.modal}>
      <div className="w-full max-w-2xl rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 flex items-start justify-between gap-3 border-b border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 px-5 py-4">
          <div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            {[
              ...
              <div key={k} className="rounded-xl border border-slate-200 dark:border-slate-700 p-3">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-slate-50 dark:bg-slate-950 text-left text-[11px] uppercase text-slate-500">
                <tr>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 dark:border-slate-700 px-3 py-2 text-xs font-semibold"
            >
