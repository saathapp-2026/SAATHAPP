  ...
  return (
    <SellerOverlay open={open} onClose={onClose} labelledBy="share-title" zIndex={SELLER_Z.modal}>
      <div className="w-full max-w-md rounded-2xl bg-surface border border-slate-200 dark:border-slate-800 shadow-xl p-5 space-y-4">
        ...
        <div className="rounded-xl bg-page p-3 flex items-center gap-2">
        ...
        <label className="block text-xs font-medium">
          ...
          <div className="mt-1 flex gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 rounded-xl border border-slate-200 px-3 py-2 text-xs font-semibold disabled:opacity-40"
            >
