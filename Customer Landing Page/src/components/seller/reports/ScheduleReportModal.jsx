        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <button
              type="submit"
              disabled={busy}
              className="transition-all duration-200 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 text-sm font-semibold disabled:opacity-50"
            >
