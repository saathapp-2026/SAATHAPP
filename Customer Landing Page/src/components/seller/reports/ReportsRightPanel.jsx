    ...
    <aside className="space-y-4 lg:sticky lg:top-4 lg:self-start" aria-label="Report shortcuts">
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 space-y-3 shadow-sm">
        ...
        <label className="block text-xs font-medium text-slate-600 dark:text-slate-300">
          ...
          <select
            ...
            className="mt-1.5 w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-transparent px-3 py-2.5 text-sm"
          >
            {REPORT_TYPES.map((t) => (
        ...
        <label className="block text-xs font-medium text-slate-600 dark:text-slate-300">
          Date Range
          <div className="mt-1.5 flex items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-700 px-3 py-2">
        ...
        <div className="grid grid-cols-4 gap-2">
          {SHORTCUTS.map((t) => (
            <button
              ...
              className="flex flex-col items-center gap-1.5 rounded-xl p-2 hover:bg-slate-50 dark:hover:bg-slate-800/60 transition-colors"
            >
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 shadow-sm">
        ...
        <button
          ...
          className="w-full rounded-xl border border-slate-200 dark:border-slate-700 py-2 text-xs font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800"
        >
          View All Downloads
        </button>
      </div>
