            ...
            >
              ...
              <form onSubmit={handleConfirmPayment} className="mt-6 space-y-4 text-xs">
                ...
                <button
                  ...
                  className="w-full mt-4 flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 hover:bg-emerald-500 py-3.5 text-xs font-black text-white shadow-xl transition hover:scale-[1.02] disabled:opacity-50"
                >
                  <Lock size={14} />
