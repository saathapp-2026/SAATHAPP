      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {paidBrandingItems.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-surface p-5 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition"
            >
              <div>
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-page dark:bg-slate-950 py-2.5 text-xs font-bold text-slate-800 dark:text-slate-200 hover:bg-emerald-600 hover:text-white transition"
              >
