        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center">
              ...
              <button
                type="button"
                className="transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none text-[10px] font-black uppercase text-blue-400 hover:text-blue-300 border-0 bg-transparent cursor-pointer"
              >
                Forgot?
              </button>
            </div>
