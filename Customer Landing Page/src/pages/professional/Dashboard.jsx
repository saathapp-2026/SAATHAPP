                ...
                {activeTab === 'dashboard' && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-3 sm:gap-4">
                      <div className="rounded-xl bg-surface border border-slate-200/60 dark:border-slate-800 p-3 sm:p-4">
                      ...
                      <div className="rounded-xl bg-surface border border-slate-200/60 dark:border-slate-800 p-3 sm:p-4 col-span-2 md:col-span-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 mb-2">
                      <div className="rounded-xl bg-surface border border-slate-200/60 dark:border-slate-800 p-3 sm:p-4 flex items-center justify-between">
                        <div>
                    ...
                    {/* EARNINGS OVERVIEW */}
                    <div className="bg-surface border border-slate-200/60 dark:border-slate-800 rounded-card p-6 shadow-soft flex flex-col md:flex-row gap-6 justify-between items-center text-left">
                      <div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-6">
                        {/* DASHBOARD RATING */}
                        <div className="bg-surface border border-slate-200/60 dark:border-slate-800 p-6 rounded-card shadow-soft text-left flex items-center justify-between">
                          <div>
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-page hover:bg-page dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs font-bold uppercase rounded-xl cursor-pointer"
                          >
                            View Reviews
                          </button>
                        </div>
