  ...
  return (
    <SectionPage title="Payment Methods" subtitle="Manage UPI, cards, and wallet payments." icon={CreditCard} onBack={onBack}>
      <div className="space-y-3">
        ...
        <button onClick={() => alert('Add payment method sheet')} className="flex items-center gap-2 rounded-2xl border border-dashed border-slate-300 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-page transition-colors w-full justify-center cursor-pointer">
