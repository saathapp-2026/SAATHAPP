          ...
          <div className="space-y-4">
            <form onSubmit={handleSearch} className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <button type="submit" className="transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none rounded-2xl bg-primary px-4 py-3 text-sm font-semibold text-white transition hover:opacity-90">
                  Search
                </button>
              </div>
            ...
            <button type="button" onClick={onUseCurrentLocation} className="transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none flex w-full items-center justify-between rounded-3xl border border-primary/20 bg-gradient-to-r from-primary/10 to-primary/5 p-4 text-left shadow-sm transition hover:shadow-md">
            ...
            <button type="button" onClick={onAddAddress} className="transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none flex w-full items-center justify-between rounded-3xl border border-dashed border-slate-300 bg-white p-4 text-left shadow-sm transition hover:border-primary hover:bg-primary/5">
              <div className="flex items-center gap-3">
